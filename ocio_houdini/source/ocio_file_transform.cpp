...
//rgb_available
bool Ocio_file_transform::rgb_available(COP2_Context& context,
	const TIL_Region* input,
	TIL_Region* output)
{
	//is_rgb_available
...
//filter_ocio
void Ocio_file_transform::filter_ocio(COP2_Context& context,
	const TIL_Region* input,
	TIL_Region* output)
{
...
//filter_no_ocio
void Ocio_file_transform::filter_no_ocio(COP2_Context& context,
	const TIL_Region* input,
	TIL_Region* output)
{
